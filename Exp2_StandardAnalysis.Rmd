...
ggplot(CA_Summary,aes(x=AccWordPrediction, y = TotalAcc))+
  geom_point()+
  geom_hline(lm(CA_Summary$TotalAcc~CA_Summary$AccWordPrediction))

plot(CA_Summary$TotalAcc,CA_Summary$AccWordPrediction,abline(lm(CA_Summary$TotalAcc~CA_Summary$AccWordPrediction)))
lm(CA_Summary$TotalAcc~CA_Summary$AccWordPrediction)
